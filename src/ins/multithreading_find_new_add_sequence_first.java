...
public class multithreading_find_new_add_sequence_first implements Callable<String>{
	String matchfile;
	int insertsize_avg;
	String fasta;
	String unmatchfq1;
	String unmatchfq2;
	positionUnit p;
	public multithreading_find_new_add_sequence_first(positionUnit pu,String matchfile,int insertsize_avg,String fasta,String unmatchfq1,String unmatchfq2) {
